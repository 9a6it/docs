...
### Быстрый старт с Vue 3 | [▲](#оглавление)
...
Возможно, вы заметили, что шаблон импортированного компонента встроен в виде JavaScript-строки. Если вы используете Visual Studio Code, вы можете установить расширение `es6-string-html` и добавить к строкам префикс-комментарий `/*html*`, чтобы получить подсветку синтаксиса для них.
